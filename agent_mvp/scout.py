#!/usr/bin/env python3
"""
Research Scout — Capstone MVP Agent
====================================
...
This is the MVP — the narrowest version of the core job that runs end-to-end.
"""
import json
import os
import subprocess
...
# ─── Config ───────────────────────────────────────────────────────────
AUDIT_LOG = Path('/home/z/my-project/agent_mvp/audit_log.json')
RUN_CAPTURE = Path('/home/z/my-project/agent_mvp/run_capture.txt')
